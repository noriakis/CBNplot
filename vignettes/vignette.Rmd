...
```
### The use of cpbnplot
Then use cpbnplot. Basically, you need to supply the enrichment analysis result, normalized expression value and samples to be included.
...
bnpathplot(results = pway,exp = vsted, expSample = incSample)
